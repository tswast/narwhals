...
_BigFrames: TypeAlias = Literal["bigframes"]
...
_PandasLike: TypeAlias = Literal[_Pandas, _BigFrames, _CuDF, _Modin]
...
_BigFramesImpl: TypeAlias = Literal[Implementation.BIGFRAMES]
...
_PandasLikeImpl: TypeAlias = Literal[_PandasImpl, _BigFramesImpl, _CuDFImpl, _ModinImpl]
